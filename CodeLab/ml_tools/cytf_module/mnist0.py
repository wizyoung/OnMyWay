...
## alternative code for above 4 lines
...
with tf.Session() as sess:
    ...
    # def TFboard_embedding(num_input, input, summary_write, save_path):
    #     '''
    #     '''
    ...
    #         # more general
    #         embedding_config.sprite.image_path = os.path.join(save_path, 'img.png')
    #         embedding_config.metadata_path = os.path.join(save_path, 'l.tsv')
    #         embedding_config.sprite
