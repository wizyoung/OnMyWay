...
# print results['video_test_0000319']
...
# recalls_avg: top@R 个 prop 中，按每个 R 对不同的阈值取均值，长度为R
# proposals_per_video: 平均每个视频获得的 proposal 个数，按 R 的比例，长度为 R
recalls_avg, proposals_per_video = average_recall_vs_nr_proposals(results, ground_truth, np.array(options['tiou_measure']))
# recalls_tiou: 固定 top@R 的比例后，每个阈值下的 recall, 长度为阈值区间
# tiou_thresholds: 对应的阈值区间
